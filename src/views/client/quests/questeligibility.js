...
const QuestEligibility = ({ setTab, onQuestEligibilitySave }) => {
  const [checked, setChecked] = useState('-1');
  const [eligibility, setEligibility] = useState({});

  const items = [
    { title: 'All users', comment: 'All participants can pass this quest', type: 'all' },
    { title: 'NFTs holder', comment: 'Users with a certain NFT can participate', type: 'nft' },
    {
      title: 'Tokens holder',
