    ...
    <div className="reward-card-right">
      ...
      <div className="field">
        ...
        <InputText
          ...
          aria-describedby="username1-help"
          className="ipt-txt"
          onChange={(e) => setNFT({ ...NFT, distribution: e.target.value })}
        />
      </div>
      <div className="field">
        <div className="label-row">
        ...
        <InputText
          ...
          aria-describedby="username1-help"
          className="ipt-txt"
          onChange={(e) => setNFT({ ...NFT, collection: e.target.value })}
        />
      </div>
      <div className="field">
        <div className="label-row">
        ...
        <InputText
          ...
          aria-describedby="username1-help"
          className="ipt-txt"
          onChange={(e) => setNFT({ ...NFT, symbol: e.target.value })}
        />
      </div>
      <div className="mb-3">
        <div className="flex align-items-center justify-content-between gap-2 mb-2">
          <Button
            ...
            onClick={() => setNFT({ ...NFT, network: 'Matic' })}>
            <img src={Icon1} />
          </Button>
          <Button
            className={`p-button-secondary nft-btn flex-grow-1 align-items-center justify-content-center reward-nft-button ${
            ...
            onClick={() => setNFT({ ...NFT, network: 'ETC' })}>
            <img src={Icon2} />
          </Button>
          <Button
            className={`p-button-secondary nft-btn flex-grow-1 align-items-center justify-content-center reward-nft-button ${
            ...
            onClick={() => setNFT({ ...NFT, network: 'APT' })}>
            <img src={Icon3} />
          </Button>
        </div>
        <div className="flex align-items-center justify-content-between gap-2 mb-2">
          <Button
            ...
            onClick={() => setNFT({ ...NFT, network: 'BSC' })}>
            <img src={Icon4} />
          </Button>
          <Button
            className={`p-button-secondary nft-btn flex-grow-1 align-items-center justify-content-center reward-nft-button ${
            ...
            onClick={() => setNFT({ ...NFT, network: 'AVAX' })}>
            <img src={Icon5} />
          </Button>
          <Button
            className={`p-button-secondary nft-btn flex-grow-1 align-items-center justify-content-center reward-nft-button ${
