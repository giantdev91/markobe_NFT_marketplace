...
const TechnicalProofsTrading = ({ closeActivity, onAction }) => {
  ...
  const addOrRemoveNetwork = (network) => {
    ...
    if (trading.networks.includes(network)) {
      const updatedNetworks = trading.networks.filter((i) => i !== network);
      setTrading((prevTrading) => ({
        ...prevTrading,
      ...
      setTrading((prevTrading) => ({
        ...prevTrading,
        networks: [...prevTrading.networks, network],
      }));
    }
  };
  ...
  const addOrRemoveDuration = (duration) => {
    ...
    if (trading.durations.includes(duration)) {
      const updatedDurations = trading.durations.filter((i) => i !== duration);
      setTrading((prevTrading) => ({
        ...prevTrading,
      ...
      setTrading((prevTrading) => ({
        ...prevTrading,
        durations: [...prevTrading.durations, duration],
      }));
    }
  };
  ...
  const onChangeLink = (index, value) => {
    setTrading((prevTrading) => {
      const newLinks = [...prevTrading.links];
      ...
      <div className="activity-item">
        <div className="close-btn">
          <img
            src={Close_Icon}
            className="close-btn"
            onClick={() => closeActivity('TechnicalProofsTrading')}
          />
        </div>
        <div
          ...
          <>
            <div className="ipt-box">
              ...
              <InputText
                ...
                style={{ width: '100%' }}
                onChange={(e) => setTrading({ ...trading, description: e.target.value })}
              />
            </div>
            <div className="ipt-box">
              ...
              <InputText
                ...
                className="ipt-txt"
                onChange={(e) => setTrading({ ...trading, smartContract: e.target.value })}
              />
            </div>
            <div className="ipt-box">
              <div className="flex align-items-center justify-content-between label-row">
              ...
              <InputText
                ...
                placeholder="Enter the answer"
                className="ipt-txt"
                onChange={(e) => setTrading({ ...trading, amount: e.target.value })}
              />
            </div>
            <div className="ipt-box">
              <div className="flex align-items-center justify-content-between label-row">
              ...
              <InputText
                ...
                placeholder="Enter the answer"
                className="ipt-txt"
                onChange={(e) => setTrading({ ...trading, ticker: e.target.value })}
              />
            </div>
            <div className="ipt-box">
            ...
            <div className="ipt-box">
              <span className="title">Trading duration</span>
              <div className="flex flex-row flex-wrap gap-2 mt-2">
                <div
                  className={`flex align-items-center justify-content-center option-btn ${
...
export default TechnicalProofsTrading;
